...
<br> Bên cạnh truyền tải thông điệp, Alice sẽ gửi kèm 1 signature (chữ ký), thứ được mã hóa từ thông điệp ban đầu (`'Qua dep trai'`) và Private Key của Alice. Điều này được mô tả ở hàm `sign` <br>
